...
\____/| .__/ \__,_|_| |_| |_| \____/|_| |_| |_|___/
	...
	def AlfaMart(Phone, Amount):
		for _ in range(Amount):
			...
			'email' : 'nuyulwae50@gmail.com',
			'password' : 'Subscribe Cannel gw yak',
			'isNewsletter' : 'on'
			}
...
if __name__ == '__main__':
	...
	sleep(2)
	os.system('clear')
	os.system('xdg-open https://www.youtube.com/channel/UCW3aCQw5WR3vahbN6EfxZ_w')
	sleep(7)
	Spam()